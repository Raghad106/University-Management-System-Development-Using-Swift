...
struct SystemApp {
    static func main() {
        ...
        let s1 = Student(name: "Raghad", major: "Computer Science", gpa: 3.8)
        let s2 = Student(name: "Rahaf", major: "Marketing", gpa: 3.8)
        let s3 = Student(name: "Rana", major: "Art", gpa: 3.8)
        ...
        let c1 = Course(courseId: 1, title: "IOS", credits: 3, professor: p1)
        let c2 = Course(courseId: 2, title: "Intro to Chemistry", credits: 3, professor: p2)
        let c3 = Course(courseId: 3, title: "Quran", credits: 3, professor: p3)
        ...
        let enrollment = Enrollment(enrollmentId: 1, student: s1, semester: "Summer 2026", grade: "A")
